                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="community_name"
                                    ...
                                    Name</label>
                                <input type="text" wire:model="community_name" id="community_name"
                            ...
                            <div>
                                <label for="facebook_links"
                                    ...
                                    Link</label>
                                <input type="url" wire:model="facebook_links" id="facebook_links"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                            </div>
                            ...
                            <div>
                                <label for="linkedin_links"
                                    ...
                                    Link</label>
                                <input type="url" wire:model="linkedin_links" id="linkedin_links"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                            </div>
                            ...
                            <div>
                                <label for="instagram_links"
                                    ...
                                    Link</label>
                                <input type="url" wire:model="instagram_links" id="instagram_links"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                            </div>
                            ...
                            <div>
                                <label for="twitter_links"
                                    ...
                                    Link</label>
                                <input type="url" wire:model="twitter_links" id="twitter_links"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                            </div>
                        </div>
